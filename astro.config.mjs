      ...
      sidebar: [
        ...
        { label: 'Authentication', slug: 'authentication' },
        {
          ...
          items: [
            ...
            { label: 'Groups', slug: 'endpoints/groups' },
            { label: 'Greek', slug: 'endpoints/greek' },
            { label: 'Greek Lexicon', slug: 'endpoints/greek-lexicon' },
            { label: 'Search', slug: 'endpoints/search' },
            { label: 'Meta & Usage', slug: 'endpoints/meta' },
          ],
        },
